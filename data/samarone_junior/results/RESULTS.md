...
> **Status:** Corrected full HPC rerun `theoryfix_20260511T044609Z` validated on 2026-05-13.

## Validation and Provenance

- **Canonical metrics:** `data/samarone_junior/results/metrics.jsonl`
- **Rows / unique keys:** 3150 / 3150
- **Grid:** 7 models × 10 seeds × 5 folds × 9 event classes = 3150 rows
- **Remote source:** `/home/samarone.lima/qml_project/results/theoryfix_20260511T044609Z/`
...
| vs. QAEReconstruction | -0.023 | 50 | 1.94 × 10^-1 | 1.94 × 10^-1 | No significant QAE-objective difference |

### QAEReconstruction vs. all models

QAEReconstruction ranks 5 with mean F1 = 0.626.
It outperforms the parameter-matched MatchedAutoencoder by Δ = +0.134 mean F1 (Holm p = 2.85 × 10^-3).
Against QAETrashFidelity, QAEReconstruction has higher mean F1 (Δ = +0.023; Holm p = 1.94 × 10^-1). This QAE-objective difference is not significant after Holm correction.
Its largest deficit is against LSTMAutoencoder (QAEReconstruction − baseline Δ = -0.246, Holm p = 1.07 × 10^-14).
...
4. **QAE objective choice:** QAEReconstruction has the higher mean F1 (QAETrashFidelity 0.603 vs. QAEReconstruction 0.626; QAETrashFidelity − QAEReconstruction Δ = -0.023, Holm p = 1.94 × 10^-1), but the paired block difference is not statistically significant.
